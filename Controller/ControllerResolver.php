...
/**
 * Resolve controller from ResourceContext instead of the request, copied from `http-kernel`.
 */
class ControllerResolver
{
     ...
     * {@inheritdoc}
     */
    public function getController(ResourceContext $context)
    {
        if (!$controller = $context->getAction()->getController()) {
            if (null !== $this->logger) {
