...
/**
 * Provides a base implementation for different kinds of a value normalizer.
 */
abstract class AbstractNormalizer implements FilterValueNormalizerInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Gets a human-readable representation of a data-type this normalizer works with.
     *
     * @return string
     */
    ...
    /**
     * Gets a human-readable representation in plural of a data-type this normalizer works with.
     *
     * @return string
     */
    ...
    /**
     * Does a value normalizer (conversion to a concrete data-type) if needed.
     *
     * @param NormalizerContext $context
     */
    protected function processNormalization(NormalizerContext $context)
    {
