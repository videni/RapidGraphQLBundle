            ...
            ->arrayPrototype()
                ->children()
                    ...
                    ->arrayNode('repository')
                        ...
                        ->children()
                            ->scalarNode('class')
                                ->defaultValue(EntityRepository::class)
                                ->cannotBeEmpty()
                                ->validate()
                                    ->ifTrue(function($v){
                                        return !class_exists($v);
                                    })
                                    ->thenInvalid('Repository class %s is not existed')
                                ->end()
                            ->end()
                            ->scalarNode('auto_alias')->defaultValue(true)->end()
                        ->end()
                    ->end()
                    ->arrayNode('factory')
                        ->addDefaultsIfNotSet()
                        ...
                        ->children()
                            ->scalarNode('class')
                                ...
                                ->validate()
                                    ...
                                    ->thenInvalid('Factory class %s is not existed')
                                ->end()
                            ->end()
                            ->scalarNode('auto_alias')->defaultValue(true)->end()
                        ->end()
